...
_080628FE:
	...
	movs r1, #0
	strh r1, [r0]
	ldr r3, _08062954 @ =gUnk_03002C60
	strh r1, [r3, #8]
	strh r1, [r3, #0xa]
	strh r1, [r3, #0xc]
	strh r1, [r3, #0xe]
...
_080629E8:
	...
	bl sub_08064518
	bl sub_08065800
	ldr r4, _08062A20 @ =gUnk_03002C60
...
sub_08065484: @ 0x08065484
	...
	mov r3, sl
	ldr r6, [r3, #8]
	ldr r0, _080655E0 @ =gUnk_03002C60
	movs r7, #1
	movs r1, #0x1c
	mov r8, r1
	adds r0, #2
...
sub_08065600: @ 0x08065600
	...
	ldr r4, [r2]
	lsls r4, r4, #0xa
	ldr r0, _08065674 @ =gUnk_03002C60
	ldrh r0, [r0, #0x12]
	mov r8, r0
...
_08067282:
	...
	adds r0, r1, #0
	orrs r2, r0
	ldr r6, _08067304 @ =gUnk_03002C60
	mov ip, r6
	mov r5, ip
	adds r5, #0x42
	movs r4, #0x3f
...
sub_080676BC: @ 0x080676BC
	...
	movs r2, #0x70
	bl memcpy
	ldr r1, _08067708 @ =gUnk_03002C60
...
_0806776E:
	...
	movs r0, #2
	bl sub_0803F8A8
	ldr r1, _080677FC @ =gUnk_03002C60
	movs r0, #4
	strh r0, [r1, #8]
...
sub_08067804: @ 0x08067804
	push {r4, r5, lr}
	movs r5, #0
	ldr r3, _08067854 @ =gUnk_03002C60
	adds r2, r3, #0
	adds r2, #0x4c
	movs r1, #8
	strh r1, [r2]
...
_08067874:
	...
	movs r1, #0x24
	bl Div
	ldr r2, _08067894 @ =gUnk_03002C60
	movs r1, #0x7c
	subs r1, r1, r0
	lsls r1, r1, #8
	adds r0, #0x7c
...
sub_08067898: @ 0x08067898
	...
	ands r0, r1
	strh r0, [r2]
	ldr r0, _080678E8 @ =gUnk_03002C60
	adds r0, #0x4c
	strh r3, [r0]
...
sub_08067934: @ 0x08067934
	...
	bl sub_08040748
	bl sub_08040FE0
	ldr r1, _080679EC @ =gUnk_03002C60
...
_08067AB4:
	...
	ldr r0, [r0]
	str r0, [sp, #0xc]
	ldr r1, _08067AE0 @ =gUnk_03002C60
...
_08067C34:
	...
	adds r0, r7, r2
	strb r1, [r0]
	ldr r2, _08067CC8 @ =gUnk_03002C60
...
_08067E1C:
	...
	cmp r1, #0
	bne _08067D5A
	ldr r0, _08067E48 @ =gUnk_03002C60
	adds r0, #0x4c
	strh r1, [r0]
	movs r0, #0xed
	lsls r0, r0, #2
...
_08067E7A:
	...
	movs r0, #8
	ands r2, r0
	ldr r0, _08067EB4 @ =gUnk_03002C60
	ldrh r1, [r0, #8]
	lsrs r1, r1, #3
	lsls r1, r1, #1
	ldrh r0, [r0, #0xa]
...
_08067F24:
	...
	ldr r2, [r2]
	bl sub_080676BC
	ldr r3, _08067FF4 @ =gUnk_03002C60
...
_08068076:
	...
	lsls r0, r0, #1
	bl sub_080D7910
	ldr r0, _080680D8 @ =gUnk_03002C60
	ldrh r1, [r0, #8]
	lsrs r1, r1, #3
	lsls r1, r1, #1
	ldrh r0, [r0, #0xa]
