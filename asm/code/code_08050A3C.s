...
_08055798:
	...
	movs r0, #0x74
	strh r0, [r7, #0x14]
	ldr r2, _080557F8 @ =gUnk_03002C60
	adds r1, r2, #0
	adds r1, #0x40
	movs r0, #0x1b
	strb r0, [r1]
...
_08055BAA:
	...
	movs r5, #0x14
	ldrsh r1, [r7, r5]
	ldr r2, _08055BD8 @ =gUnk_03002C60
...
_0805624C:
	...
	orrs r0, r1
	strb r0, [r2]
	ldr r0, _08056298 @ =gUnk_03002C60
	adds r0, #0x4a
	movs r1, #0x10
	strh r1, [r0]
	movs r0, #0x80
...
_0805629C:
	...
	adds r0, r1, #1
	strb r0, [r4, #0xd]
	ldr r2, _080562C4 @ =gUnk_03002C60
	b _080562EC
	.align 2, 0
_080562C0: .4byte 0x0000042C
_080562C4: .4byte gUnk_03002C60
_080562C8:
	adds r2, r5, #0
	adds r2, #0x58
	ldrb r0, [r2]
	...
	ands r0, r1
	strb r0, [r2]
	ldr r1, _08056320 @ =gUnk_03002C60
	adds r2, r1, #0
	adds r2, #0x4a
...
_0805A280:
	movs r0, #0xa
	strb r0, [r6, #0xb]
	ldr r1, _0805A300 @ =gUnk_03002C60
	adds r2, r1, #0
	adds r2, #0x42
	movs r0, #0x3f
	strb r0, [r2]
...
sub_0805AE64: @ 0x0805AE64
	...
	movs r3, #0
	strh r0, [r2]
	ldr r1, _0805AEB4 @ =gUnk_03002C60
...
sub_0805AF68: @ 0x0805AF68
	...
	orrs r0, r1
	strb r0, [r2]
	ldr r0, _0805AFBC @ =gUnk_03002C60
	adds r0, #0x48
	movs r6, #0
	movs r1, #0xff
	strh r1, [r0]
...
_0805B02C:
	bl sub_08000B64
	ldr r1, _0805B0CC @ =gUnk_03002C60
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #1
	movs r4, #0
...
_0805B110:
	ldr r1, _0805B128 @ =gUnk_03002C60
	adds r1, #0x4c
	ldrh r0, [r1]
	subs r0, #1
	strh r0, [r1]
...
_0805B172:
	...
	b _0805B40C
_0805B194:
	ldr r1, _0805B1CC @ =gUnk_03002C60
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
_0805B240:
	bl sub_08000B64
	bl sub_0800D1F0
	ldr r2, _0805B294 @ =gUnk_03002C60
	adds r1, r2, #0
	adds r1, #0x4c
	ldrh r0, [r1]
	subs r0, #1
...
_0805B25C:
	...
	b _0805B40C
	.align 2, 0
_0805B294: .4byte gUnk_03002C60
_0805B298: .4byte gEwramData
_0805B29C: .4byte 0x0000A074
_0805B2A0:
	ldr r1, _0805B2D4 @ =gUnk_03002C60
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
_0805B2EE:
	...
	movs r3, #0
	bl sub_0803F8A8
	ldr r2, _0805B314 @ =gUnk_03002C60
	movs r1, #0
	movs r0, #0
	strh r0, [r2, #8]
	strb r1, [r5, #0xb]
...
_0805B314: .4byte gUnk_03002C60
_0805B318:
	ldr r0, _0805B340 @ =gUnk_03002C60
	adds r4, r0, #0
	adds r4, #0x4c
	ldrh r0, [r4]
	cmp r0, #0x10
...
_0805B344:
	...
	b _0805B40A
_0805B356:
	ldr r1, _0805B3D8 @ =gUnk_03002C60
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
_0805BB14:
	...
	adds r0, #0x60
	bl sub_08011AD0
	ldr r0, _0805BB98 @ =gUnk_03002C60
	adds r0, #0x48
	movs r1, #0
	strh r7, [r0]
	ldrb r0, [r6, #0xb]
...
_0805CBA8:
	ldr r0, _0805CBB8 @ =gUnk_03002C60
	adds r0, #0x44
	...
	b _0805CC52
	.align 2, 0
_0805CBB8: .4byte gUnk_03002C60
_0805CBBC: .4byte 0x0000FFFF
_0805CBC0:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CBE0 @ =gUnk_03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
	...
	b _0805CC2A
	.align 2, 0
_0805CBE0: .4byte gUnk_03002C60
_0805CBE4:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC08 @ =gUnk_03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
	...
	b _0805CCD2
	.align 2, 0
_0805CC08: .4byte gUnk_03002C60
_0805CC0C:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC30 @ =gUnk_03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
...
_0805CC2A:
	...
	b _0805CCD2
	.align 2, 0
_0805CC30: .4byte gUnk_03002C60
_0805CC34:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC5C @ =gUnk_03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
...
_0805CC66:
	...
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC8C @ =gUnk_03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
