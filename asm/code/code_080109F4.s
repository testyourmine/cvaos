...
_08010FB4:
	...
	cmp r7, #0x22
	ble _08010F56
	ldr r0, _08010FF0 @ =gDisplayRegisters
	movs r1, #0xe2
	lsls r1, r1, #5
	strh r1, [r0]
	movs r1, #2
...
_08010FF0: .4byte gDisplayRegisters
...
sub_08010FF4: @ 0x08010FF4
	...
	bne _080110BC
_080110A4:
	ldr r0, _080110B8 @ =gDisplayRegisters
	adds r0, #0x4c
	mov r1, r8
	b _080110C6
	.align 2, 0
...
_080110B8: .4byte gDisplayRegisters
_080110BC:
	ldr r0, _080110E0 @ =gDisplayRegisters
	movs r1, #0xf
	ands r3, r1
	adds r1, r3, #1
	adds r0, #0x4c
...
_080110D4:
	...
	bx r0
	.align 2, 0
_080110E0: .4byte gDisplayRegisters
...
_08011154:
	ldr r1, _08011168 @ =gDisplayRegisters
	movs r0, #0
	strh r0, [r1, #8]
	strh r0, [r1, #0xa]
	bl sub_0803C294
	...
	b _0801130C
	.align 2, 0
_08011168: .4byte gDisplayRegisters
...
_08011170:
	...
	lsls r3, r3, #1
	strh r3, [r4]
	ldr r2, _080111C4 @ =gDisplayRegisters
	adds r1, r2, #0
	adds r1, #0x4c
	ldrh r0, [r1]
	subs r0, #4
...
_080111C4: .4byte gDisplayRegisters
...
_080111D0:
	...
	b _08011316
_080111E0:
	ldr r4, _08011204 @ =gDisplayRegisters
	adds r1, r4, #0
	adds r1, #0x48
	movs r2, #0
	movs r3, #0
	...
	b _08011314
	.align 2, 0
_08011204: .4byte gDisplayRegisters
_08011208:
	ldr r1, _08011224 @ =gDisplayRegisters
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #4
	strh r0, [r1]
...
_0801121C:
	...
	b _08011314
	.align 2, 0
_08011224: .4byte gDisplayRegisters
_08011228:
	bl sub_0803C3E0
	bl sub_0800DA50
...
_08011268:
	...
	ldr r0, [r2, #8]
	bl sub_08000B64
	ldr r1, _080112EC @ =gDisplayRegisters
	adds r2, r1, #0
	adds r2, #0x4c
	movs r0, #0
	strh r0, [r2]
...
_080112EC: .4byte gDisplayRegisters
_080112F0: .4byte 0x0000A074
_080112F4:
	ldr r0, _08011308 @ =gDisplayRegisters
	adds r1, r0, #0
	adds r1, #0x4c
	ldrh r0, [r1]
	cmp r0, #0xf
	...
	b _08011316
	.align 2, 0
_08011308: .4byte gDisplayRegisters
_0801130C:
	adds r0, r5, #0
	bl sub_08010D60
	movs r0, #1
...
sub_08011338: @ 0x08011338
	...
	mov sb, r0
	bl sub_0800D154
	ldr r0, _080113F8 @ =gDisplayRegisters
	mov ip, r0
	mov r1, ip
	adds r1, #0x48
	movs r0, #0
	...
	bx r0
	.align 2, 0
_080113F8: .4byte gDisplayRegisters
...
sub_080115D4: @ 0x080115D4
	...
	adds r4, r0, #0
	bl sub_0800D154
	ldr r0, _08011678 @ =gDisplayRegisters
	mov ip, r0
	mov r1, ip
	adds r1, #0x48
	movs r0, #0
	...
	bx r0
	.align 2, 0
_08011678: .4byte gDisplayRegisters
...
_080116FC:
	...
	orrs r0, r1
	strb r0, [r2]
	ldr r2, _080117C8 @ =gDisplayRegisters
	mov sb, r2
	mov r0, sb
	adds r0, #0x4c
	ldrh r0, [r0]
...
_080117C8: .4byte gDisplayRegisters
...
_080117D4:
	...
	lsls r0, r0, #7
	strh r0, [r1]
	ldr r2, _08011818 @ =gDisplayRegisters
	adds r1, r2, #0
	adds r1, #0x4c
	ldrh r0, [r1]
	subs r0, #4
...
_08011818: .4byte gDisplayRegisters
...
_08011824:
	...
	movs r2, #8
	subs r2, r2, r3
	ldr r6, _080118C4 @ =gDisplayRegisters
	movs r3, #7
	ands r4, r3
	adds r4, #8
	movs r3, #0x4c
...
_080118C4: .4byte gDisplayRegisters
_080118C8:
	movs r0, #1
	mov r2, r8
	ands r2, r0
...
_080118D4:
	...
	b _08011A18
_08011908:
	ldr r1, _08011924 @ =gDisplayRegisters
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #4
	strh r0, [r1]
...
_0801191C:
	...
	b _08011A18
	.align 2, 0
_08011924: .4byte gDisplayRegisters
_08011928:
	bl sub_0803C3E0
	bl sub_0800DA50
...
_08011968:
	...
	ldr r0, [r2, #8]
	bl sub_08000B64
	ldr r1, _080119F0 @ =gDisplayRegisters
	adds r2, r1, #0
	adds r2, #0x4c
	movs r0, #0
	strh r0, [r2]
...
_080119F0: .4byte gDisplayRegisters
_080119F4: .4byte 0x0000A074
_080119F8:
	ldr r0, _08011A0C @ =gDisplayRegisters
	adds r1, r0, #0
	adds r1, #0x4c
	ldrh r0, [r1]
	cmp r0, #0xf
	...
	b _08011A1A
	.align 2, 0
_08011A0C: .4byte gDisplayRegisters
_08011A10:
	adds r0, r5, #0
	bl sub_08010D60
	movs r0, #1
...
sub_08011AD0: @ 0x08011AD0
	push {r4, r5, r6, lr}
	ldr r2, _08011B18 @ =gDisplayRegisters
	adds r3, r2, #0
	adds r3, #0x48
	movs r6, #0
	movs r1, #0xff
	...
	bx r0
	.align 2, 0
_08011B18: .4byte gDisplayRegisters
...
_08011C3C:
	...
	movs r4, #0
	strh r0, [r1]
	ldr r5, _08011CCC @ =gDisplayRegisters
	adds r1, r5, #0
	adds r1, #0x4c
	movs r0, #8
	strh r0, [r1]
...
_08011CCC: .4byte gDisplayRegisters
...
_08013FEC:
	...
	lsls r0, r0, #5
	strh r0, [r1]
	ldr r4, _08014088 @ =gDisplayRegisters
...
_08014088: .4byte gDisplayRegisters
...
_080140D4:
	...
	subs r1, #1
	strh r1, [r2, #4]
	ldr r3, _080140FC @ =gDisplayRegisters
	lsls r1, r1, #0x10
	lsrs r1, r1, #0x11
	lsls r2, r1, #8
	movs r0, #0x10
	...
	b _080142BA
	.align 2, 0
_080140FC: .4byte gDisplayRegisters
_08014100:
	ldrb r0, [r2, #0x11]
	adds r0, #1
	strb r0, [r2, #0x11]
...
_08014190:
	...
	str r0, [r5, #4]
	ldr r0, _080141C0 @ =EntityUpdateNothing
	str r0, [r5]
...
_080141C0: .4byte EntityUpdateNothing
...
_08014210:
	...
	bl sub_0803D270
	bl sub_0803CED4
	ldr r1, _08014248 @ =gDisplayRegisters
	adds r2, r1, #0
	adds r2, #0x48
	movs r0, #0xbf
	strh r0, [r2]
	...
	b _0801425E
	.align 2, 0
_08014248: .4byte gDisplayRegisters
...
_0801425E:
	...
	orrs r0, r1
	strb r0, [r2]
	ldr r2, _080142D0 @ =gDisplayRegisters
	adds r0, r2, #0
	adds r0, #0x48
	movs r1, #0
	strh r1, [r0]
...
_080142D0: .4byte gDisplayRegisters
...
_0801437A:
	strh r0, [r1]
	ldr r1, _080143AC @ =gDisplayRegisters
	movs r3, #0
...
_080143AC: .4byte gDisplayRegisters
...
_08014474:
	ldr r0, _0801448C @ =gDisplayRegisters
	adds r0, #0x4c
	movs r2, #0
	movs r1, #0
	strh r1, [r0]
	...
	b _0801453E
	.align 2, 0
_0801448C: .4byte gDisplayRegisters
_08014490:
	movs r4, #0x84
	lsls r4, r4, #8
	movs r0, #1
...
_080144C6:
	...
	bl sub_080D7910
	ldr r0, _08014504 @ =gDisplayRegisters
	adds r0, #0x48
	movs r2, #0
	movs r1, #0xbf
	strh r1, [r0]
...
_08014504: .4byte gDisplayRegisters
_08014508:
	ldr r6, _08014524 @ =gDisplayRegisters
	ldr r0, [r4]
	ldrh r0, [r0, #4]
	lsrs r0, r0, #3
	adds r5, r6, #0
	...
	b _0801453E
	.align 2, 0
_08014524: .4byte gDisplayRegisters
_08014528:
	ldr r0, [r4]
	adds r0, #0x60
	bl sub_0800C7A4
