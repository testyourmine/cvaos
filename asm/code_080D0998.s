...
sub_080D23B8: @ 0x080D23B8
	...
	movs r3, #0x80
	lsls r3, r3, #9
	ldr r4, _080D23CC @ =0x084F0B14
	b _080D23F4
	.align 2, 0
_080D23CC: .4byte 0x084F0B14
_080D23D0:
	ldr r0, _080D2418 @ =0x084F0B14
	ldr r1, [r0]
...
_080D79E0: .4byte 0x030020E0
	...
	thumb_func_start sub_080D79E4
sub_080D79E4: @ 0x080D79E4
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #4
	ldr r5, _080D7A60 @ =0x04000208
	movs r2, #0
	strh r2, [r5]
	ldr r4, _080D7A64 @ =0x04000200
	ldrh r1, [r4]
	ldr r0, _080D7A68 @ =0x0000FF3F
	ands r0, r1
	strh r0, [r4]
	movs r0, #1
	mov r8, r0
	strh r0, [r5]
	ldr r0, _080D7A6C @ =0x04000134
	strh r2, [r0]
	ldr r2, _080D7A70 @ =0x04000128
	movs r1, #0x80
	lsls r1, r1, #6
	adds r0, r1, #0
	strh r0, [r2]
	ldrh r0, [r2]
	ldr r3, _080D7A74 @ =0x00004003
	adds r1, r3, #0
	orrs r0, r1
	strh r0, [r2]
	movs r6, #0
	str r6, [sp]
	ldr r7, _080D7A78 @ =0x03005190
	ldr r2, _080D7A7C @ =0x0500003C
	mov r0, sp
	adds r1, r7, #0
	bl CpuSet
	movs r0, #0xc
	...
	bx r0
	.align 2, 0
_080D7A60: .4byte 0x04000208
_080D7A64: .4byte 0x04000200
_080D7A68: .4byte 0x0000FF3F
_080D7A6C: .4byte 0x04000134
_080D7A70: .4byte 0x04000128
_080D7A74: .4byte 0x00004003
_080D7A78: .4byte 0x03005190
_080D7A7C: .4byte 0x0500003C

	thumb_func_start sub_080D7A80
sub_080D7A80: @ 0x080D7A80
	push {r4, r5, r6, r7, lr}
	mov ip, r0
	ldr r6, _080D7A9C @ =0x04000128
	ldr r5, [r6]
	ldr r0, _080D7AA0 @ =0x03005190
	ldrb r2, [r0, #1]
	adds r7, r0, #0
	cmp r2, #1
	beq _080D7B08
	...
	b _080D7B3E
	.align 2, 0
_080D7A9C: .4byte 0x04000128
_080D7AA0: .4byte 0x03005190
_080D7AA4:
	cmp r2, #2
	beq _080D7B38
	b _080D7B3E
_080D7AAA:
	...
	cmp r0, #0xc
	bne _080D7B04
	ldr r3, _080D7B1C @ =0x04000208
	strh r1, [r3]
	ldr r2, _080D7B20 @ =0x04000200
	ldrh r1, [r2]
	ldr r0, _080D7B24 @ =0x0000FF7F
	ands r0, r1
	strh r0, [r2]
	ldrh r0, [r2]
	movs r1, #0x40
	...
	ands r0, r1
	strb r0, [r6, #1]
	ldr r1, _080D7B28 @ =0x0400010C
	ldr r0, _080D7B2C @ =0x0000B1FC
	str r0, [r1]
	adds r1, #0xf6
	movs r0, #0xc0
	strh r0, [r1]
...
_080D7B08:
	...
	b _080D7B38
	.align 2, 0
_080D7B1C: .4byte 0x04000208
_080D7B20: .4byte 0x04000200
_080D7B24: .4byte 0x0000FF7F
_080D7B28: .4byte 0x0400010C
_080D7B2C: .4byte 0x0000B1FC
_080D7B30: .4byte 0x03005190
_080D7B34:
	movs r0, #2
	strb r0, [r1, #1]
_080D7B38:
...
_080D7B8E:
	...
	thumb_func_start sub_080D7B94
sub_080D7B94: @ 0x080D7B94
	push {r4, r5, lr}
	movs r5, #0
	ldr r4, _080D7BDC @ =0x03005190
	ldr r2, [r4, #0x1c]
	ldrb r1, [r4, #0xb]
	strb r1, [r2]
	ldr r3, [r4, #0x1c]
...
_080D7BBC:
	...
	bx r0
	.align 2, 0
_080D7BDC: .4byte 0x03005190
_080D7BE0: .4byte 0x04000004

	thumb_func_start sub_080D7BE4
sub_080D7BE4: @ 0x080D7BE4
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	movs r0, #0
	str r0, [sp]
	ldr r2, _080D7C90 @ =0x04000208
	movs r3, #0
	strh r0, [r2]
	ldr r4, _080D7C94 @ =0x03005190
	ldr r1, [r4, #0x2c]
	ldr r0, [r4, #0x28]
	str r0, [r4, #0x2c]
	str r1, [r4, #0x28]
...
_080D7C60:
	...
	mov r0, r8
	adds r1, r4, #0
	ldr r2, _080D7C9C @ =0x05000004
	bl CpuSet
	adds r5, r6, #0
	cmp r5, #1
	ble _080D7C22
_080D7C74:
	ldr r1, _080D7C94 @ =0x03005190
	ldrb r0, [r1, #2]
	ldrb r2, [r1, #3]
	orrs r0, r2
	strb r0, [r1, #2]
	...
	bx r1
	.align 2, 0
_080D7C90: .4byte 0x04000208
_080D7C94: .4byte 0x03005190
_080D7C98: .4byte 0x04000004
_080D7C9C: .4byte 0x05000004

	thumb_func_start sub_080D7CA0
sub_080D7CA0: @ 0x080D7CA0
	push {r4, r5, lr}
	ldr r4, _080D7CF8 @ =0x03005190
	ldrb r5, [r4]
	cmp r5, #0
	beq _080D7D08
	ldrb r0, [r4, #1]
	...
	str r0, [r4, #0x14]
_080D7CD8:
	ldr r2, _080D7CFC @ =0x04000128
	ldr r0, [r2]
	lsls r0, r0, #0x19
	lsrs r0, r0, #0x1f
	strb r0, [r4, #7]
	ldr r0, _080D7D00 @ =0x0000FEFE
	strh r0, [r2, #2]
	ldrh r0, [r2]
	movs r1, #0x80
	orrs r0, r1
	strh r0, [r2]
	ldr r1, _080D7D04 @ =0x0400010E
	movs r0, #0xc0
	strh r0, [r1]
	b _080D7D22
	.align 2, 0
_080D7CF8: .4byte 0x03005190
_080D7CFC: .4byte 0x04000128
_080D7D00: .4byte 0x0000FEFE
_080D7D04: .4byte 0x0400010E
_080D7D08:
	ldrb r0, [r4, #9]
	cmp r0, #0
	bne _080D7D20
	ldr r3, _080D7D28 @ =0x04000208
	strh r5, [r3]
	ldr r2, _080D7D2C @ =0x03007FF8
	ldrh r0, [r2]
	movs r1, #0x80
	orrs r0, r1
	strh r0, [r2]
...
_080D7D22:
	...
	bx r0
	.align 2, 0
_080D7D28: .4byte 0x04000208
_080D7D2C: .4byte 0x03007FF8

	thumb_func_start sub_080D7D30
sub_080D7D30: @ 0x080D7D30
	push {r4, r5, lr}
	sub sp, #8
	ldr r0, _080D7E10 @ =0x04000120
	ldr r1, [r0, #4]
	ldr r0, [r0]
	str r0, [sp]
	str r1, [sp, #4]
	ldr r2, _080D7E14 @ =0x03005190
	ldr r0, _080D7E18 @ =0x04000128
	ldr r0, [r0]
	lsls r0, r0, #0x19
	lsrs r0, r0, #0x1f
	movs r5, #0
	...
	str r5, [r4, #0x14]
_080D7D7E:
	ldr r3, _080D7E20 @ =0x04000208
	strh r5, [r3]
	ldr r2, _080D7E24 @ =0x03007FF8
	ldrh r0, [r2]
	movs r1, #0x80
	orrs r0, r1
	strh r0, [r2]
...
_080D7E04:
	...
	bx r0
	.align 2, 0
_080D7E10: .4byte 0x04000120
_080D7E14: .4byte 0x03005190
_080D7E18: .4byte 0x04000128
_080D7E1C: .4byte 0x0000FEFE
_080D7E20: .4byte 0x04000208
_080D7E24: .4byte 0x03007FF8
_080D7E28: .4byte 0x0400010E

	thumb_func_start sub_080D7E2C
sub_080D7E2C: @ 0x080D7E2C
	push {lr}
	ldr r1, _080D7E40 @ =0x03005190
	ldrb r0, [r1]
	cmp r0, #0
	beq _080D7E3A
	movs r0, #1
...
_080D7E3A:
	...
	bx r0
	.align 2, 0
_080D7E40: .4byte 0x03005190

	thumb_func_start sub_080D7E44
sub_080D7E44: @ 0x080D7E44
	push {r4, lr}
	ldr r3, _080D7E78 @ =0x04000208
	movs r4, #0
	strh r4, [r3]
	ldr r2, _080D7E7C @ =0x04000200
	ldrh r1, [r2]
	ldr r0, _080D7E80 @ =0x0000FF3F
	ands r0, r1
	strh r0, [r2]
	movs r0, #1
	strh r0, [r3]
	ldr r1, _080D7E84 @ =0x04000128
	ldr r2, _080D7E88 @ =0x00002003
	adds r0, r2, #0
	strh r0, [r1]
	subs r1, #0x1c
	ldr r0, _080D7E8C @ =0x0000B1FC
	str r0, [r1]
	adds r1, #0xf6
	movs r0, #0xc0
	strh r0, [r1]
	ldr r0, _080D7E90 @ =0x03005190
	strb r4, [r0, #6]
	pop {r4}
	pop {r0}
	bx r0
	.align 2, 0
_080D7E78: .4byte 0x04000208
_080D7E7C: .4byte 0x04000200
_080D7E80: .4byte 0x0000FF3F
_080D7E84: .4byte 0x04000128
_080D7E88: .4byte 0x00002003
_080D7E8C: .4byte 0x0000B1FC
_080D7E90: .4byte 0x03005190

	thumb_func_start sub_080D7E94
sub_080D7E94: @ 0x080D7E94
	push {r4, r5, lr}
	sub sp, #4
	ldr r5, _080D7EE0 @ =0x03005280
	adds r4, r5, #0
	adds r4, #0x50
	ldrb r0, [r4]
	cmp r0, #0
...
_080D7EB4:
	...
	bx r0
	.align 2, 0
_080D7EE0: .4byte 0x03005280
_080D7EE4: .4byte 0x00000A2C
_080D7EE8: .4byte 0x0100000E

	thumb_func_start sub_080D7EEC
sub_080D7EEC: @ 0x080D7EEC
	push {lr}
	ldr r0, _080D7F0C @ =0x03005280
	ldr r1, [r0, #0x4c]
	movs r0, #0xf0
	lsls r0, r0, #4
	ands r0, r1
...
_080D7F18:
	...
	thumb_func_start sub_080D7F1C
sub_080D7F1C: @ 0x080D7F1C
	push {lr}
	bl sub_080D7CA0
	pop {r0}
	bx r0
	...
	thumb_func_start sub_080D7F28
sub_080D7F28: @ 0x080D7F28
	push {r4, lr}
	movs r4, #0
	bl sub_080D80CC
	cmp r0, #0
...
_080D7F3E:
	...
	thumb_func_start sub_080D7F48
sub_080D7F48: @ 0x080D7F48
	push {lr}
	bl sub_080D80BC
	movs r2, #0
	lsls r0, r0, #0x10
...
_080D7F58:
	movs r3, #0
	ldr r1, _080D7F70 @ =0x03005280
	lsls r0, r2, #4
	adds r0, r0, r1
	ldrh r1, [r0, #0x10]
	ldr r0, _080D7F74 @ =0x00000A2C
	cmp r1, r0
	bne _080D7F6A
	movs r3, #1
_080D7F6A:
	...
	bx r1
	.align 2, 0
_080D7F70: .4byte 0x03005280
_080D7F74: .4byte 0x00000A2C

	thumb_func_start sub_080D7F78
sub_080D7F78: @ 0x080D7F78
	push {lr}
	sub sp, #4
	bl sub_080D79E4
	ldr r2, _080D7FA8 @ =0x04000128
	ldrh r0, [r2]
	movs r1, #0x80
	orrs r0, r1
	strh r0, [r2]
	movs r3, #0
	str r3, [sp]
	ldr r1, _080D7FAC @ =0x040000D4
	mov r0, sp
	str r0, [r1]
	ldr r2, _080D7FB0 @ =0x03005280
	str r2, [r1, #4]
	ldr r0, _080D7FB4 @ =0x85000015
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	adds r2, #0x50
	strb r3, [r2]
	...
	bx r0
	.align 2, 0
_080D7FA8: .4byte 0x04000128
_080D7FAC: .4byte 0x040000D4
_080D7FB0: .4byte 0x03005280
_080D7FB4: .4byte 0x85000015

	thumb_func_start sub_080D7FB8
sub_080D7FB8: @ 0x080D7FB8
	push {lr}
	bl sub_080D7E2C
	ldr r0, _080D7FCC @ =0x03005280
	adds r0, #0x50
	movs r1, #1
	strb r1, [r0]
	pop {r0}
	bx r0
	.align 2, 0
_080D7FCC: .4byte 0x03005280

	thumb_func_start sub_080D7FD0
sub_080D7FD0: @ 0x080D7FD0
	push {lr}
	bl sub_080D7E44
	ldr r0, _080D7FE4 @ =0x03005280
	adds r0, #0x50
	movs r1, #0
	strb r1, [r0]
	pop {r0}
	bx r0
	.align 2, 0
_080D7FE4: .4byte 0x03005280

	thumb_func_start sub_080D7FE8
sub_080D7FE8: @ 0x080D7FE8
	push {r4, lr}
	adds r2, r1, #0
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	ldr r3, _080D8008 @ =0x03005280
	lsls r0, r2, #0x10
	asrs r0, r0, #0xf
	adds r1, r3, #0
	adds r1, #0x30
...
_080D8018:
	...
	thumb_func_start sub_080D8020
sub_080D8020: @ 0x080D8020
	push {r4, r5, r6, r7, lr}
	adds r6, r0, #0
	adds r4, r1, #0
	movs r3, #0
...
_080D8076:
	...
	bx r1
	.align 2, 0
_080D8084: .4byte 0x03005280

	thumb_func_start sub_080D8088
sub_080D8088: @ 0x080D8088
	push {r4, r5, lr}
	adds r5, r0, #0
	adds r4, r1, #0
	bl sub_080D80BC
	lsls r0, r0, #0x10
	ldr r3, _080D80B8 @ =0x03005292
	cmp r0, #0
	bne _080D809C
	adds r3, #0x10
_080D809C:
...
_080D80B2:
	...
	bx r0
	.align 2, 0
_080D80B8: .4byte 0x03005292

	thumb_func_start sub_080D80BC
sub_080D80BC: @ 0x080D80BC
	ldr r0, _080D80C8 @ =0x04000128
	ldr r0, [r0]
	lsls r0, r0, #0x1a
	lsrs r0, r0, #0x1e
	bx lr
	.align 2, 0
_080D80C8: .4byte 0x04000128

	thumb_func_start sub_080D80CC
sub_080D80CC: @ 0x080D80CC
	push {lr}
	movs r2, #0
	ldr r0, _080D80E4 @ =0x03005280
	ldr r0, [r0, #0x4c]
	ldr r1, _080D80E8 @ =0x00003001
	ands r0, r1
	cmp r0, #1
	bne _080D80DE
	movs r2, #1
_080D80DE:
	...
	bx r1
	.align 2, 0
_080D80E4: .4byte 0x03005280
_080D80E8: .4byte 0x00003001

	thumb_func_start sub_080D80EC
sub_080D80EC: @ 0x080D80EC
	push {lr}
	ldr r2, _080D8110 @ =0x030052CC
	ldr r0, [r2]
	movs r1, #0x80
	lsls r1, r1, #8
	ands r0, r1
