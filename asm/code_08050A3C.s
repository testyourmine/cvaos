...
_08051968:
	...
	b _080519F8
	.align 2, 0
_08051990: .4byte 0x084F0B14
_08051994: .4byte 0x00013110
_08051998:
	mov r4, sl
	cmp r4, #1
	bne _080519C8
	ldr r0, _08051A04 @ =0x084F0B14
	ldr r0, [r0]
...
_08052BC4: .4byte 0x084F0B14
_08052BC8: .4byte 0x0000042C
_08052BCC:
	movs r0, #0
	bl sub_0800C5A8
	ldr r4, _08052C18 @ =0x084F0B14
	ldr r0, [r4]
...
_08052D46:
	...
	b _08052E96
	.align 2, 0
_08052D5C: .4byte 0x084F0B14
_08052D60: .4byte 0x0000042C
_08052D64:
	ldr r4, _08052DB8 @ =0x084F0B14
	ldr r0, [r4]
...
_080557F4: .4byte 0x03002CB0
_080557F8: .4byte 0x03002C60
_080557FC: .4byte 0x00013110
_08055800: .4byte 0x0000A074
_08055804:
	ldr r2, _08055830 @ =0x03002CB0
	ldrh r1, [r2]
...
_08055BD0: .4byte 0x084F0B14
_08055BD4: .4byte 0xFFFFE000
_08055BD8: .4byte 0x03002C60
...
_0805629C:
	...
	adds r0, r1, #1
	strb r0, [r4, #0xd]
	ldr r2, _080562C4 @ =0x03002C60
	b _080562EC
	.align 2, 0
_080562C0: .4byte 0x0000042C
_080562C4: .4byte 0x03002C60
_080562C8:
	adds r2, r5, #0
	adds r2, #0x58
	ldrb r0, [r2]
...
_0805A23A:
	...
	b _0805A2D6
	.align 2, 0
_0805A27C: .4byte 0x084F0B14
_0805A280:
	movs r0, #0xa
	strb r0, [r6, #0xb]
	ldr r1, _0805A300 @ =0x03002C60
	adds r2, r1, #0
	adds r2, #0x42
	movs r0, #0x3f
	strb r0, [r2]
...
_0805A2F6:
	...
	bx r0
	.align 2, 0
_0805A300: .4byte 0x03002C60
_0805A304: .4byte 0x084F0B14
...
sub_0805AE64: @ 0x0805AE64
	push {lr}
	ldr r2, _0805AEAC @ =0x03002CB0
	ldrh r1, [r2]
	ldr r0, _0805AEB0 @ =0x000013FF
	ands r0, r1
	movs r3, #0
	strh r0, [r2]
	ldr r1, _0805AEB4 @ =0x03002C60
	...
	b _0805AEFC
	.align 2, 0
_0805AEAC: .4byte 0x03002CB0
_0805AEB0: .4byte 0x000013FF
_0805AEB4: .4byte 0x03002C60
_0805AEB8: .4byte 0x00001C04
_0805AEBC: .4byte 0x0815E3EC
_0805AEC0: .4byte 0x084F0B14
...
sub_0805AF68: @ 0x0805AF68
	...
	bx r0
	.align 2, 0
_0805AFB4: .4byte 0x084F0B14
_0805AFB8: .4byte 0x0000A074
_0805AFBC: .4byte 0x03002C60
...
_0805B1A8:
	...
	b _0805B1E2
	.align 2, 0
_0805B1CC: .4byte 0x03002C60
_0805B1D0: .4byte 0x084F0B14
...
_0805B234: .4byte 0x084F0B14
_0805B238: .4byte 0x0000A0E8
_0805B23C: .4byte 0x0000A0EC
_0805B240:
	bl sub_08000B64
	bl sub_0800D1F0
	ldr r2, _0805B294 @ =0x03002C60
	adds r1, r2, #0
	adds r1, #0x4c
	ldrh r0, [r1]
	subs r0, #1
...
_0805B25C:
	...
	b _0805B40C
	.align 2, 0
_0805B294: .4byte 0x03002C60
_0805B298: .4byte 0x084F0B14
_0805B29C: .4byte 0x0000A074
_0805B2A0:
	ldr r1, _0805B2D4 @ =0x03002C60
	adds r1, #0x4c
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
...
_0805B314: .4byte 0x03002C60
_0805B318:
	ldr r0, _0805B340 @ =0x03002C60
	adds r4, r0, #0
	adds r4, #0x4c
	ldrh r0, [r4]
	cmp r0, #0x10
...
_0805BEF0:
	...
	b _0805BF16
	.align 2, 0
_0805BEF8: .4byte 0x03002CB0
_0805BEFC: .4byte 0x0000FEFF
_0805BF00:
	adds r0, r4, #0
	movs r1, #1
	bl sub_0805B66C
	ldr r2, _0805BF20 @ =0x03002CB0
	ldrh r1, [r2]
	movs r3, #0x80
	lsls r3, r3, #1
	adds r0, r3, #0
...
_0805BF16:
	...
	bx r1
	.align 2, 0
_0805BF20: .4byte 0x03002CB0

	thumb_func_start sub_0805bf24
sub_0805bf24: @ 0x0805BF24
	push {lr}
	ldr r0, _0805BF40 @ =0x084F0B14
	ldr r1, [r0]
...
_0805C14C:
	...
	b _0805C1E6
	.align 2, 0
_0805C1A0: .4byte 0x03002CB0
_0805C1A4: .4byte 0x0000FEFF
_0805C1A8:
	bl sub_0803D408
	cmp r0, #0
	bne _0805C1E6
	ldr r4, _0805C208 @ =0x084F0B14
	ldr r1, [r4]
...
_0805C730: .4byte 0x03002CB0
_0805C734:
	ldr r2, _0805C740 @ =0x03002CB0
	ldrh r1, [r2]
...
_0805CAD6:
	...
	bx r1
	.align 2, 0
_0805CAF8: .4byte 0x03002CB0
_0805CAFC: .4byte 0x0000FEFF
_0805CB00: .4byte 0x084F0B14
...
_0805CBA8:
	...
	b _0805CC52
	.align 2, 0
_0805CBB8: .4byte 0x03002C60
_0805CBBC: .4byte 0x0000FFFF
_0805CBC0:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CBE0 @ =0x03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
	...
	b _0805CC2A
	.align 2, 0
_0805CBE0: .4byte 0x03002C60
_0805CBE4:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC08 @ =0x03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
	...
	b _0805CCD2
	.align 2, 0
_0805CC08: .4byte 0x03002C60
_0805CC0C:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC30 @ =0x03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
...
_0805CC2A:
	...
	b _0805CCD2
	.align 2, 0
_0805CC30: .4byte 0x03002C60
_0805CC34:
	ldrb r6, [r5, #0xd]
	lsls r3, r6, #0x18
	lsrs r4, r3, #0x1a
	ldr r2, _0805CC5C @ =0x03002C60
	lsls r0, r4, #4
	orrs r0, r4
	lsls r1, r4, #8
	orrs r0, r1
...
_0805D99A:
	...
	b _0805DA8E
	.align 2, 0
_0805D9D0: .4byte 0x03002CB0
_0805D9D4: .4byte 0x084F0B14
