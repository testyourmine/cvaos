...
_08092124:
	...
	thumb_func_start sub_0809212C
sub_0809212C: @ 0x0809212C
	push {lr}
	bl sub_0808F964
	pop {r0}
	bx r0
	...
	thumb_func_start sub_08092138
sub_08092138: @ 0x08092138
	push {lr}
	bl sub_0808FA30
	pop {r0}
	bx r0
	...
	thumb_func_start sub_08092144
sub_08092144: @ 0x08092144
	push {lr}
	bl sub_0808F964
	pop {r0}
	bx r0
...
sub_0809215C: @ 0x0809215C
	...
	thumb_func_start sub_08092168
sub_08092168: @ 0x08092168
	push {lr}
	bl sub_0808FA30
	pop {r0}
	bx r0
	...
	thumb_func_start sub_08092174
sub_08092174: @ 0x08092174
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #0x18
...
_08092344:
	...
	thumb_func_start sub_08092350
sub_08092350: @ 0x08092350
	push {r4, lr}
	adds r4, r0, #0
	bl sub_08092680
	lsls r0, r0, #0x18
...
_0809285C:
	...
	thumb_func_start sub_08092868
sub_08092868: @ 0x08092868
	push {r4, lr}
	adds r4, r0, #0
	bl sub_08093100
	lsls r0, r0, #0x18
...
_080936F4:
	...
	thumb_func_start sub_080936FC
sub_080936FC: @ 0x080936FC
	push {lr}
	bl sub_080936A0
	pop {r0}
	bx r0
	...
	thumb_func_start sub_08093708
sub_08093708: @ 0x08093708
	push {lr}
	bl sub_08093178
	pop {r0}
	bx r0
...
_080938E0:
	...
	thumb_func_start sub_080938E8
sub_080938E8: @ 0x080938E8
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r4, r0, #0
...
_08093C16:
	...
	thumb_func_start sub_08093C34
sub_08093C34: @ 0x08093C34
	push {r4, r5, lr}
	sub sp, #0x14
	adds r4, r0, #0
	ldrb r0, [r4, #0xa]
...
_08093D1A:
	...
	thumb_func_start sub_08093D24
sub_08093D24: @ 0x08093D24
	push {r4, r5, lr}
	adds r4, r0, #0
	bl sub_080946C4
	lsls r0, r0, #0x18
...
_08094748:
	...
	thumb_func_start sub_08094750
sub_08094750: @ 0x08094750
	push {r4, r5, r6, lr}
	sub sp, #0x34
	adds r5, r0, #0
	ldrb r0, [r5, #0xa]
...
sub_080952EC: @ 0x080952EC
	...
	thumb_func_start sub_08095320
sub_08095320: @ 0x08095320
	push {r4, r5, lr}
	sub sp, #0x38
	adds r4, r0, #0
	adds r1, r4, #0
...
_08095498: .4byte 0x00FFFFFF
	...
	thumb_func_start sub_0809549C
sub_0809549C: @ 0x0809549C
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
sub_08098EA4: @ 0x08098EA4
	...
	thumb_func_start sub_08098EEC
sub_08098EEC: @ 0x08098EEC
	push {lr}
	bl sub_08095320
	pop {r0}
	bx r0
...
sub_08098EF8: @ 0x08098EF8
	...
	thumb_func_start sub_08098F04
sub_08098F04: @ 0x08098F04
	push {r4, r5, r6, r7, lr}
	sub sp, #0x18
	adds r5, r0, #0
...
sub_080994B0: @ 0x080994B0
	...
	thumb_func_start sub_080994E0
sub_080994E0: @ 0x080994E0
	push {r4, lr}
	sub sp, #0x14
	adds r4, r0, #0
	ldrb r0, [r4, #0xa]
...
_080995AE:
	...
	thumb_func_start sub_080995B8
sub_080995B8: @ 0x080995B8
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	ldr r6, _080995D8 @ =0x084F0B14
	ldr r0, [r6]
...
_08099C56:
	...
	thumb_func_start sub_08099C5C
sub_08099C5C: @ 0x08099C5C
	push {r4, lr}
	adds r4, r0, #0
	bl sub_0809A3D8
	lsls r0, r0, #0x18
...
sub_0809A424: @ 0x0809A424
	...
	thumb_func_start sub_0809A450
sub_0809A450: @ 0x0809A450
	push {r4, lr}
	sub sp, #0x30
	adds r4, r0, #0
	bl sub_0806CC20
...
_0809C6B2:
	...
	thumb_func_start sub_0809C6BC
sub_0809C6BC: @ 0x0809C6BC
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #0xc
	adds r4, r0, #0
	ldr r0, _0809C724 @ =0x084F0B14
	ldr r2, [r0]
...
sub_080A00AC: @ 0x080A00AC
	...
	thumb_func_start sub_080A00DC
sub_080A00DC: @ 0x080A00DC
	push {r4, r5, r6, r7, lr}
	sub sp, #0x14
	adds r5, r0, #0
	ldr r0, _080A0130 @ =0x084F0B14
	ldr r0, [r0]
...
_080A01B0:
	...
	thumb_func_start sub_080A01B8
sub_080A01B8: @ 0x080A01B8
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	ldr r5, _080A01D8 @ =0x084F0B14
	ldr r0, [r5]
...
sub_080A07D0: @ 0x080A07D0
	...
	thumb_func_start sub_080A07FC
sub_080A07FC: @ 0x080A07FC
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
